        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Empowering individuals on their journey to improved mental health
              and wellbeing through accessible, professional care.
            </p>
              ...
              {[
                {
                  ...
                  icon: (
                    <svg
                      className="h-5 w-5 text-gray-400 hover:text-blue-600 transition-colors duration-300"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                      aria-hidden="true"
                    >
        ...
        <div className="mt-12 pt-8 border-t border-blue-100">
          <div className="text-center">
            <p className="text-xs text-gray-500">
              © {new Date().getFullYear()} HealingMinds. All rights reserved.
            </p>
            <p className="mt-2 text-xs text-gray-400 leading-relaxed max-w-2xl mx-auto">
              If you're experiencing a mental health emergency, please call your
              local emergency number or the National Suicide Prevention Lifeline
              at 1-800-273-8255.
            </p>
          </div>
        </div>
